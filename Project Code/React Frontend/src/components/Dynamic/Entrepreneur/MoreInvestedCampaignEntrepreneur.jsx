...
class MoreInvestedCampaignEntrepreneurs extends React.Component {
  componentDidMount() {
    this.props.dispatch(campaignAction.TrendingCampaigns());
  }
  render() {
    const {
      ...
      <div className="campaign trendingCompaign">
        <div className="row heading">
          <div className="col-md-5">
            <h1>Have More Invested Campaigns Entrepreneur </h1>
          </div>
          <div className="col-md-5" />
...
const connectedTrendingCampaigns = connect(mapStateToProps)(
  MoreInvestedCampaignEntrepreneurs
);
export { connectedTrendingCampaigns as MoreInvestedCampaignEntrepreneurs };
