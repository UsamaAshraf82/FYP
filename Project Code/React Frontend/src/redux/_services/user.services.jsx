...
function update(user) {
    ...
    return fetch(config.apiUrl +'api/users/Detail_' + user.UserId, requestOptions).then(handleResponse, handleError);
}
...
function Stories() {
    ...
    return fetch(config.apiUrl +'api/users/Story', requestOptions).then(handleResponse, handleError);
}
